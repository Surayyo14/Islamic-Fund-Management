  ...
  <nav className="navbar-links">
    <ul>
       ...
       < select className="select-header" name="" id="">
        ...
        <option value="International educational programs">International educational programs</option>
        <option value="Specialized courses">Specialized courses</option>
        <option value="Islamic Finance Literacy Course">Islamic Finance Literacy Course</option>
